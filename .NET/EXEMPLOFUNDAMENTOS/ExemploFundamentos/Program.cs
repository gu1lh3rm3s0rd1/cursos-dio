...
// arrayInteiros[1] = 64;
// arrayInteiros[2] = 50;
// //arrayInteiros[3] = 1; // array quebrou aqui pois definimos um array de 3 posicoes e nao 4
...
{
    Console.WriteLine($"Posicao numero {contador} - {listaString[contador]}");
}
...
{
    Console.WriteLine($"Posicao numero {contadorForeach} - {item}");
    contadorForeach++;
}
